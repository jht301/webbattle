...
class BattleScene extends Phaser.Scene {
    ...
    fireBuster() {
        ...
        this.projectiles.push({
            sprite: spr, dx: 0, dy: -720, damage: 1,
    ...
    fireChargeShot() {
        ...
        this.projectiles.push({
            sprite: spr, dx: 0, dy: -600, damage: 10,
            owner: 'player', type: 'pixel', alive: true
        });
    ...
    useChip(index) {
        ...
        switch (name) {
            case 'Cannon': {
                ...
                this.projectiles.push({
                    sprite: spr, dx: 0, dy: -840, damage: 40,
                    owner: 'player', type: 'pixel', alive: true
                });
                break;
            }
            ...
            case 'Spreader': {
                ...
                this.projectiles.push({
                    sprite: spr, dx: 0, dy: -600, damage: 20,
